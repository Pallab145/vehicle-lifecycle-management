...
import { Loader2, Car, ArrowLeftRight, UserCheck, Menu } from 'lucide-react';
      ...
      <NotificationProvider>
        ...
        <div className="hidden md:flex w-64 flex-col border-r bg-background">
          <div className="flex h-16 items-center border-b px-6">
            <h2 className="text-lg font-bold tracking-tight text-primary">Citizen Portal</h2>
          </div>
        ...
        <div className="flex flex-1 flex-col overflow-hidden">
          ...
          <header className="flex h-16 items-center justify-between border-b bg-background px-4 md:px-6 sticky top-0 z-10">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-lg font-semibold md:hidden">Vehicle Lifecycle</h2>
            </div>
